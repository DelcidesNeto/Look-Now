...
class Servico extends StatelessWidget{
  ...
  @override Widget build(BuildContext context){
    return InkWell(
      ...
      splashColor: temaAplicativo.screens.screenTelaPrincipal.tabHoje.inkWell.splashColor,
      //hoverColor: temaAplicativo.screens.screenTelaPrincipal.tabHoje.inkWell.hoverColor,
      onTap: (){},
      child: Container(
...
class TabHoje extends StatefulWidget{
  const TabHoje({super.key});
  @override State<TabHoje> createState() => _TabHoje();
}

class _TabHoje extends State<TabHoje>{
